...
function HeaderLayout() {
  return (
    <header className="bg-white w-full">
      <div className=" w-[95%] mx-auto px-2 py-5 flex items-center">
        {/* logo */}
        ...
        <div className="w-full max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden xl:flex items-center">
          <select
            ...
            name
            id>
            <option className="px-4 py-4">Tất cả các sản phẩm</option>
            <option>Sản phẩm loại 1</option>
            <option>Sản phẩm loại 2</option>
            <option>Sản phẩm loại 3</option>
            <option>Sản phẩm loại 4</option>
            <option>Sản phẩm loại 5</option>
          </select>
          <input
        ...
        <div className="ml-auto md:w-48 hidden sm:flex flex-col place-items-end">
          <span className="font-bold md:text-xl">+ 84 352 988 596</span>
